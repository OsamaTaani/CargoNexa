...
router.get('/driver', authMiddleware.authorize([2]) ,driverController.getDriverById);

router.put('/update-drivers', authMiddleware.authorize([2]) ,driverController.updateDriverById);
