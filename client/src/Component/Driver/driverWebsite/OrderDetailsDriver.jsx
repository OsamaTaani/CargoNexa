...
// calculate the Driver Profit
  const [orderAmount, setOrderAmount] = useState(price);
  ...
  return (
    ...
    <div className='flex '>
      <div className="flex flex-col-reverse ml-0 sm:ml-6">
            ...
            <div className="flex flex-col-reverse ml-0 sm:ml-6">
              <dt className="text-sm font-medium text-slate-600"> {orderDetails.payment_method}</dt>
              <dd className="text-xs text-slate-500">Payment method:</dd>
            </div>
            </div>
    </div>
