...
const DriverHistoryPage = () => {
  ...
  return (
    ...
    <div className="bg-white p-8 rounded-md w-full">
      ...
      <div className="flex">
    <div>
      <h2 className="text-gray-600 font-bold mr-10 md:mr-40">Driver Orders</h2>
    </div>
            ...
            <table className="min-w-full leading-normal">
              ...
              {filteredOrders.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(order => (
                <tr key={order.order_id}>
                  ...
                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <p className="text-gray-900 whitespace-no-wrap">{order.shipping_timestamp}</p>
                  </td>
                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <p className="text-gray-900 whitespace-no-wrap">{order.receiving_timestamp}</p>
                  </td>
