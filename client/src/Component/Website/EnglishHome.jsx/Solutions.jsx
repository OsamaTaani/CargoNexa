        ...
        <div className='mb-20 md:mb-40'>
            <div>
                <span className="group font-extrabold text-xl md:text-2xl xl:text-3xl flex justify-start">
                    <div className=" ml-20 block py-2 pl-3 pr-4 text-black rounded md:bg-transparent md:p-0 relative" aria-current="page">
                    {t('solutions.Logistic Solutions')} 
                        <div className="w-32 md:w-[17rem] h-1  bg-my-green"></div>
                    </div>
                </span>
                <br />
                <span className="group text-sm md:text-xl xl:text-xl">
                    <div className=" ml-10 md:ml-20 mb-5 block py-2 pl-3 pr-4 text-black rounded md:bg-transparent md:p-0 relative" aria-current="page">
                    {t('solutions.LogisticDescription')}                     </div>
                </span>
                <div>
                    <Link to={'/solutions'}>
                          ...
                          <div class="flex justify-center relative rounded-lg overflow-hidden h-40 md:h-64">
                              <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                                  <div class="absolute inset-0 ">
                                      <img src={solution.solution_image} alt='' />
                                  </div>
                              </div>
